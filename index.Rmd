...
For each of these proteins, we have gathered **Gene ontology (GO) IDs** and cross-referenced **InterPro domains**, using UniProt's ID mapping [online service](https://www.uniprot.org/uploadlists/) (selecting `UniProtKB` mapping `To` option and selecting the appropriate columns).
